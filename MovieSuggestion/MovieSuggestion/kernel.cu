...
#include "MovieResources/FileReader.h"
#include "UserResources/UserTableReader.h"
#include <chrono>
#include <sstream>
using namespace std;
...
cudaError_t doAlgo()
{
	...
	MovieReader m = MovieReader("Data/movies.csv");
	UserTableReader r = UserTableReader("Data/ratings.csv");
	...
	computeSimularMovies << <dim3(blockX, blockY), dim3(blockDim, blockDim) >> > (d_userReviewMatrix, d_userReviewMatrixRows, d_movieMatrix, d_userReviewMatrixColumns);
